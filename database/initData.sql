...
INSERT INTO `achieve-goal-contract`.`post` (`userId`, `title`, `content`, `distributionTokenAmount`, `certificationStartDate`, `certificationEndDate`, `certificationCycle`, `certificationTime`) VALUES ('1', '제목2', '안녕하세요.', '100000', '2022-07-15', '2022-08-02', '3', '10');
INSERT INTO `achieve-goal-contract`.`post` (`userId`, `title`, `content`, `distributionTokenAmount`, `certificationStartDate`, `certificationEndDate`, `certificationCycle`, `certificationTime`) VALUES ('2', '제목3', '안녕하세요.', '300000', '2022-07-15', '2022-08-02', '2', '8');
...
INSERT INTO `achieve-goal-contract`.`post` (`userId`, `title`, `content`, `distributionTokenAmount`, `certificationStartDate`, `certificationEndDate`, `certificationCycle`, `certificationTime`) VALUES ('3', '제목5', '안녕하세요.', '150000', '2022-07-15', '2022-08-06', '7', '6');
...
INSERT INTO `achieve-goal-contract`.`post` (`userId`, `title`, `content`, `distributionTokenAmount`, `certificationStartDate`, `certificationEndDate`, `certificationCycle`, `certificationTime`) VALUES ('5', '제목7', '안녕하세요.', '400000', '2022-07-15', '2022-08-02', '2', '11');
